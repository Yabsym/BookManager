...
<body class="index">
<div class="container">
    <div class="logo"><a href="/admin">管理员后台</a></div>
    <div class="left_open"><a><i title="展开左侧栏" class="iconfont">&#xe699;</i></a>
    </div>
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:"><%out.print(admin.getAdminName());%></a>
            <dl class="layui-nav-child">
                <dd><a onclick="xadmin.open('个人信息','/admin/pagePersonal',500,600)">个人信息</a></dd>
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a onclick="xadmin.add_tab('管理员列表','/admin/pageAdminList')">
                    <i class="iconfont">&#xe6a7;</i><cite>管理员列表</cite>
                </a>
            </li>
            <li>
                <a onclick="xadmin.add_tab('用户列表','/admin/pageBorrowerList')">
                    <i class="iconfont">&#xe6a7;</i><cite>用户列表</cite>
                </a>
            </li>

            <li>
                <a onclick="xadmin.add_tab('图书列表','/admin/pageBookList')">
                    <i class="iconfont">&#xe6a7;</i><cite>图书列表</cite>
                </a>
            </li>
            <li>
                <a onclick="xadmin.add_tab('借阅列表','/admin/pageBorrowList')">
                    <i class="iconfont">&#xe6a7;</i><cite>借阅列表</cite>
                </a>
            </li>
            <li>
                <a onclick="xadmin.add_tab('系统日志','/admin/pageLogList')">
                    <i class="iconfont">&#xe6a7;</i><cite>系统日志</cite>
                </a>
            </li>
        </ul>
    </div>
