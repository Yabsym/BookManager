...
<head>
    ...
    <script type="text/javascript" src="../../../static/js/borrower/pageBorrowList.js"></script>
    <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
            ...
            <div class="layui-card">
                ...
                <script id="toolbarBorrow" type="text/html">
                    <div class="layui-card-header">
                        ...
                        <button class="layui-btn layui-btn-sm layui-btn-normal" lay-event="deleteBorrow">归还</button>
                    </div>
                </script>
                <div class="layui-card-body ">
