...
<div class="box">
    <div class="box__ghost">
        ...
        <div class="box__ghost-container">
            ...
            <div class="box__ghost-bottom"></div>
        </div>
        <div class="box__ghost-shadow"></div>
    </div>
    <div class="box__description">
        <div class="box__description-container">
            <div class="box__description-title">505!</div>
            <div class="box__description-text">ERROR</div>
        </div>
        <a href="/" target="_blank" class="box__button">GO LOGIN</a>
    </div>
</div>
</body>
</html>